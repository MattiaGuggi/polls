...
const Profile = () => {
  const pollsContainer = useRef(null);
        ...
        <>
          <div className="min-h-screen w-full flex flex-col items-center justify-center relative overflow-hidden py-10">
            ...
            <div className="relative z-10 flex flex-col items-center w-full max-w-2xl mx-auto p-8">
              ...
              <button
                className="cursor-pointer mt-5 py-3 px-4 bg-gradient-to-r from-indigo-700 to-indigo-950 text-white font-bold rounded-lg shadow-lg hover:from-indigo-800 hover:to-indigo-950 hover:scale-110 transition duration-200 w-full max-w-xs"
              ...
              <button
                onClick={logout}
                className="cursor-pointer mt-6 px-6 py-2 bg-red-600 hover:bg-red-800 text-white font-semibold rounded-lg shadow-md transition-all duration-200 hover:scale-110 w-full max-w-xs"
              >
                Logout
              </button>
            </div>
